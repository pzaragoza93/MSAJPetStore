...
import interfaces.ProxyAccountService;
...
public class AccountActionBean extends AbstractActionBean {
  ...
  @SpringBean
  private transient ProxyAccountService accountService;
  @SpringBean
  ...
  @Validate(on = { "signon", "newAccount", "editAccount" }, required = true)
  ...
  public Resolution signon() {
    ...
    System.out.println("first name: " + account.getFirstName() + " account: " + account.getUsername());
