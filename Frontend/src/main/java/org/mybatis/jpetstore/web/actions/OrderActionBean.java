...
import interfaces.ProxyOrderService;
...
public class OrderActionBean extends AbstractActionBean {
  ...
  @SpringBean
  private transient ProxyOrderService orderService;
  ...
  public Resolution newOrderForm() {
    ...
    if (accountBean == null || !accountBean.isAuthenticated()) {
      ...
      System.out.println("(initOrder) newOrderForm:" + accountBean.getAccount().getFirstName() + " username: "
  ...
  public Resolution newOrder() {
    ...
    if (shippingAddressRequired) {
      ...
      System.out.println("(OrderActionBean.newOrder) account username from order: " + order.getUsername());
